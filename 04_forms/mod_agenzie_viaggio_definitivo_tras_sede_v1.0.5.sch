...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:ns uri="../04_forms/mod_agenzie_viaggio_definitivo_tras_sede_v1.0.5.xsd" prefix="mavdefv"/>
...
<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici" abstract="false" is-a="dati_anagrafici_ab">-->
<!--        <sch:param name="nsscheana" value="sschedaanag"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici_iscrizione_registro" abstract="false" is-a="iscrizione_REA_ab">-->
<!--        <sch:param name="iscrizione_REA" value="eimpresa:rea"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici_indirizzo_italiano_residenza" abstract="false" is-a="indirizzo_italiano_ab">-->
<!--        <sch:param name="indirizzo_italiano" value="sscheana:indirizzo_italiano"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici_indirizzo_estero_residenza" abstract="false" is-a="indirizzo_estero_ab">-->
<!--        <sch:param name="indirizzo_estero" value="sscheana:indirizzo_estero"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici_impresa" abstract="false" is-a="impresa_ab">-->
<!--        <sch:param name="impresa" value="sscheana:impresa"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici_persona" abstract="false" is-a="persona_ab">-->
<!--        <sch:param name="persona" value="sscheana:persona"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici_cittadinanza" abstract="false" is-a="cittadinanza_ab">-->
<!--        <sch:param name="cittadinanza" value="sscheana:cittadinanza"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici_permesso_soggiorno" abstract="false" is-a="documento_rilasciato_ab">-->
<!--        <sch:param name="documento_rilasciato" value="sscheana:permesso_soggiorno"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_dati_anagrafici_rappresentanza" abstract="false" is-a="rappresentanza_ab">-->
<!--        <sch:param name="rappresentanza" value="sscheana:rappresentanza"/>-->
<!--    </sch:pattern>-->

<!--    <sch:pattern id="mod_agenzie_viaggio_definitivo_tras_sede_anagrafica_attivita" abstract="false" is-a="anagrafica_attivita_ab">-->
